 ...
 * for order checkout payments, as distinct from social "zaps". Returns
 * both the invoice and, if the provider supports LUD-21, a `verify` URL
 * that can be polled later to check whether it's been paid.
 */
