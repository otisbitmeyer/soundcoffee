          ...
          <div className="flex items-center gap-4 sm:gap-3">
            ...
            {playlistEpisodes.length > 0 && (
              <button
                ...
                aria-label="Play SC Radio"
                title="Play SC Radio"
                className="flex h-8 w-8 items-center justify-center border-2 border-jade bg-jade text-ink transition hover:bg-transparent hover:text-jade"
              >
